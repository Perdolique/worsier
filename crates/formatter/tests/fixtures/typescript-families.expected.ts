...
type Primitives = any | bigint | boolean | never | null | number | object | string | symbol
| undefined | unknown | void | this;
...
interface Base<T> {
  readonly value: T; optional?: string; method<U>(value: U): T; new(value: T): Base<T>;
  [key: string]: unknown;
}
...
abstract class Service<T> {
  abstract readonly value: T; private secret?: string; protected accessor current: T;
  static { this.ready = true; } constructor(public input: T) {} abstract method<U>(value: U): T;
}
const satisfies = {
  value: 'text', method: <U>(value: U) => 'text'
} satisfies Partial<Base<string>>;

...
export default function declared(value = defaultValue, ...rest) {
  return { value, rest };
}
export class Derived extends namespace.Base {
  static count = 0;
  #value = 1;
  constructor(value) {
    super();
...
const object = {
  ...
  async load() {
    return import('./lazy.js', { with: { type: 'json' } });
  },
  *iterate() {
    yield* array;
  },
...
export {
  array, calculation, chained, choice, created, expression, generate, literals, object, run, tagged
};
